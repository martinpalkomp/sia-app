    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-12">
          ...
          <section>
            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Foundational Principles</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              
              {/* Law 01 */}
              <div className="rounded-2xl border border-indigo-500/20 bg-[#111827] p-6 relative overflow-hidden flex flex-col xl:flex-row gap-6 group hover:border-indigo-500/40 transition-colors shadow-[0_0_15px_-3px_rgba(99,102,241,0.05)] hover:shadow-[0_0_20px_-3px_rgba(99,102,241,0.15)]">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-center">
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-4">
                    <div>
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-1.5 mb-1.5"><Brain size={10} className="text-zinc-500" /> Driven By</h4>
                      <p className="text-[11px] text-zinc-300 leading-snug">Adenosine accumulation in the brain</p>
                    </div>
                    <div>
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-1.5 mb-1.5"><Activity size={10} className="text-zinc-500" /> Impact</h4>
                    ...
                    <div className="col-span-2 pt-3 border-t border-zinc-800/50 mt-1">
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-1.5 mb-1.5"><Shield size={10} className="text-zinc-500" /> Key Fact</h4>
              ...
              <div className="rounded-2xl border border-indigo-500/20 bg-[#111827] p-6 relative overflow-hidden flex flex-col xl:flex-row gap-6 group hover:border-indigo-500/40 transition-colors shadow-[0_0_15px_-3px_rgba(99,102,241,0.05)] hover:shadow-[0_0_20px_-3px_rgba(99,102,241,0.15)]">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-center">
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-4">
                    <div>
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-1.5 mb-1.5"><Brain size={10} className="text-zinc-500" /> Control Center</h4>
                      <p className="text-[11px] text-zinc-300 leading-snug">Suprachiasmatic nucleus (SCN) in the brain</p>
                    </div>
                    <div>
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-1.5 mb-1.5"><Clock size={10} className="text-zinc-500" /> Chronotypes</h4>
          ...
          <section>
            <div className="mb-6">
              <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">How SIA Uses Signals</h3>
              <p className="text-xs text-zinc-400 font-sans">From data to personalized intelligence</p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 relative">
              {[
                ...
                <div key={i} className="border border-zinc-800/60 bg-[#0B0F17] rounded-xl p-4 flex flex-col justify-between min-h-[140px] z-10 relative group hover:border-zinc-700/80 transition-colors shadow-sm">
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-[9px] font-mono text-zinc-500">{item.step}.</span>
                      <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase">{item.title}</h4>
                    </div>
                    <div className="mb-4 text-zinc-400">{item.icon}</div>
                  </div>
                  <p className="text-[10px] text-zinc-400 font-sans leading-relaxed balance">{item.desc}</p>
                </div>
              ))}
          ...
          <section>
            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Evidence-Based Topics</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {[
                ...
                <button 
                  ...
                  className="text-left border border-zinc-800/60 bg-[#0B0F17] hover:bg-[#111827] hover:border-zinc-700 transition-colors rounded-xl p-4 flex flex-col items-start gap-4 group shadow-sm"
                >
                  <div className="text-zinc-500 group-hover:text-zinc-300 transition-colors">{topic.icon}</div>
                  <div>
                    <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase mb-2">{topic.title}</h4>
                    <p className="text-[10px] text-zinc-500 font-sans leading-relaxed">{topic.desc}</p>
                  </div>
                </button>
              ))}
            </div>
        ...
        <div className="space-y-8">
          ...
          <div className="border border-indigo-500/10 bg-[#111827] rounded-2xl overflow-hidden relative p-6 shadow-[0_0_15px_-3px_rgba(99,102,241,0.05)]">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">SIA Quick Insight (Example)</h3>
          ...
          <div className="border border-zinc-800/60 bg-[#0B0F17] rounded-2xl p-6 shadow-sm">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6">Key Signals SIA Tracks</h3>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between group">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded border border-zinc-800/50 bg-zinc-900 flex items-center justify-center text-zinc-500 group-hover:text-zinc-300 group-hover:border-zinc-700 transition-colors">
                      {signal.icon}
                    </div>
                    <div>
                      <div className="text-[11px] font-black tracking-tight text-slate-300 mb-0.5">{signal.name}</div>
                      <div className="text-[9px] font-sans text-zinc-500">{signal.desc}</div>
                    </div>
                  </div>
                  <div className={`text-[11px] font-black tracking-tighter ${signal.color}`}>
                    {signal.val}
                  </div>
                </div>
              ))}

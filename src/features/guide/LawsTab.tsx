        ...
        <div className="border border-zinc-800/60 bg-[#0B0F17] rounded-2xl overflow-hidden relative shadow-sm">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-zinc-800/50">
              <div className="p-8">
                <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-2 mb-3"><Brain size={12} className="text-zinc-500" /> Core Principle</h4>
              ...
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-2 mb-3"><Activity size={12} className="text-zinc-500" /> Key Signal</h4>
                 <p className="text-[11px] font-sans text-zinc-300 leading-relaxed">
                   Short sleep duration (&lt;7h) prevents clearance of adenosine, leading to carry-over pressure the next day.
                 </p>
              </div>
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-2 mb-3"><Clock size={12} className="text-zinc-500" /> Behavioral Impact</h4>
                 <p className="text-[11px] font-sans text-zinc-300 leading-relaxed">
                   Cognitive impairment increases progressively before subjective fatigue is consciously perceived.
                 </p>
              </div>
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-widest text-slate-400 uppercase flex items-center gap-2 mb-3"><FileText size={12} className="text-zinc-500" /> Evidence</h4>

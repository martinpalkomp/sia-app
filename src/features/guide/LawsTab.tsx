    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-12">
        <div className="max-w-2xl">
          <h2 className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-2">The Two Laws of Sleep</h2>
        ...
        {/* LAW 01 BLOCK */}
        <div className="border border-zinc-800 bg-zinc-900/30 rounded-2xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <div className="p-8 border-b border-zinc-800/50">
              <span className="text-[10px] font-black tracking-widest text-indigo-400 border border-indigo-500/20 bg-indigo-500/10 px-2 py-0.5 rounded inline-block mb-4">LAW 01</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-zinc-800/50">
              <div className="p-8">
                <h4 className="text-[9px] font-black tracking-wider text-zinc-500 uppercase flex items-center gap-2 mb-3"><Brain size={12} className="text-zinc-400" /> Core Principle</h4>
                <p className="text-xs text-zinc-300 leading-relaxed">
                  Adenosine builds up in the basal forebrain while awake, creating biological "pressure" for sleep. 
                </p>
              </div>
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-wider text-zinc-500 uppercase flex items-center gap-2 mb-3"><Activity size={12} className="text-zinc-400" /> Key Signal</h4>
                 <p className="text-xs text-zinc-300 leading-relaxed">
                   Short sleep duration (&lt;7h) prevents clearance of adenosine, leading to carry-over pressure the next day.
                 </p>
              </div>
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-wider text-zinc-500 uppercase flex items-center gap-2 mb-3"><Clock size={12} className="text-zinc-400" /> Behavioral Impact</h4>
                 <p className="text-xs text-zinc-300 leading-relaxed">
                   Cognitive impairment increases progressively before subjective fatigue is consciously perceived.
                 </p>
              </div>
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-wider text-zinc-500 uppercase flex items-center gap-2 mb-3"><FileText size={12} className="text-zinc-400" /> Evidence</h4>
                 <p className="text-xs text-zinc-400 leading-relaxed">
                   Borbély, A. A. (1982). A two process model of sleep regulation. <i className="text-zinc-500">Human Neurobiology</i>.
                 </p>
              </div>
            </div>
          </div>
        ...
        <div className="border border-zinc-800 bg-zinc-900/30 rounded-2xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            {/* Header */}
            <div className="p-8 border-b border-zinc-800/50">
              <span className="text-[10px] font-black tracking-widest text-indigo-400 border border-indigo-500/20 bg-indigo-500/10 px-2 py-0.5 rounded inline-block mb-4">LAW 02</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-zinc-800/50">
              ...
              <div className="p-8">
                 <h4 className="text-[9px] font-black tracking-wider text-zinc-500 uppercase flex items-center gap-2 mb-3"><FileText size={12} className="text-zinc-400" /> Evidence</h4>
                 <p className="text-xs text-zinc-400 leading-relaxed">
                   Roenneberg, T., et al. (2003). Life between clocks: daily temporal patterns of human chronotypes. <i className="text-zinc-500">Journal of Biological Rhythms</i>.
                 </p>
              </div>
            </div>
          </div>

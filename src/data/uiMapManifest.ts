  ...
  Dashboard: [
    {
      ...
      children: [
        ...
        { id: 'gate-explore-btn', name: 'Explore Factors Button', tag: 'btn', description: 'Button to show prediction factors', path: '/src/features/dashboard/SleepGateHero.tsx', function: 'Toggles prediction factors visibility on mobile/desktop.', tierDiff: null, maturityDiff: null, aiUsed: null, trigger: null, dependsOn: [] },
